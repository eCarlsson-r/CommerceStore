...
export default function WishlistPage() {
  ...
  if (wishlist.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h1 className="text-2xl font-black uppercase italic italic tracking-tighter">Your Collection is Empty</h1>
        <p className="mt-4 text-[10px] text-gray-400 font-bold uppercase tracking-widest max-w-xs leading-loose">
           Curate your favorite pieces from our 11 boutiques across North Sumatra.
        </p>
  ...
  return (
    <div className="py-20">
      <h1 className="text-3xl font-black uppercase italic italic mb-12">My Selection</h1>
